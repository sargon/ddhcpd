...
#define STAT_MCAST_SEND_UPDATECLAIM 4
#define STAT_MCAST_RECV_UPDATECLAIM 5
#define STAT_MCAST_SEND_INQUIRE 6
#define STAT_MCAST_RECV_INQUIRE 7
#define STAT_DIRECT_RECV_PKG 8
#define STAT_DIRECT_SEND_PKG 9
#define STAT_DIRECT_RECV_BYTE 10
#define STAT_DIRECT_SEND_BYTE 11
#define STAT_DIRECT_RECV_RENEWLEASE 12
#define STAT_DIRECT_SEND_RENEWLEASE 13
#define STAT_DIRECT_RECV_LEASEACK 14
#define STAT_DIRECT_SEND_LEASEACK 15
#define STAT_DIRECT_RECV_LEASENAK 16
#define STAT_DIRECT_SEND_LEASENAK 17
#define STAT_DIRECT_RECV_RELEASE 18
#define STAT_DIRECT_SEND_RELEASE 19
#define STAT_DHCP_RECV_PKG 20
#define STAT_DHCP_SEND_PKG 21
#define STAT_DHCP_RECV_BYTE 22
#define STAT_DHCP_SEND_BYTE 23
#define STAT_DHCP_RECV_DISCOVER 24
#define STAT_DHCP_SEND_OFFER 25
#define STAT_DHCP_RECV_REQUEST 26
#define STAT_DHCP_SEND_ACK 27
#define STAT_DHCP_SEND_NAK 28
#define STAT_DHCP_RECV_RELEASE 29
#define STAT_NUM_OF_FIELDS 30
